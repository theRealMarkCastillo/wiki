...
- **Toolsets** include `terminal` (git pull/push), `file` (read/write pages), `session_search` (gather week's context), `skills` (load skill instructions), and `search` (find past dreams/diaries)
